				...
				<div class="grid grid-cols-6 gap-2">
					{#each colorPalette as paletteColor (paletteColor)}
						<button
							...
							class="relative h-9 rounded-lg border-2 transition-all hover:scale-105 {color.toLowerCase() ===
		...
		<div class="flex items-center justify-between gap-3 pt-2">
			<div>
				{#if isEditMode && onDelete}
					<button
						...
						disabled={saving}
						class="px-4 py-2 text-sm font-medium text-red-400 hover:text-red-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
					>
						Delete
					</button>
				{/if}
			...
			<div class="flex gap-2">
				<button
					...
					disabled={saving}
					class="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
				>
					Cancel
				</button>
				<button
					...
					class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
				>
