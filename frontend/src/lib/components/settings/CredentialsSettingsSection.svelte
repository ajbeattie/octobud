	...
	<form on:submit|preventDefault={handleSubmit} class="space-y-4">
		...
		<div class="flex justify-end">
			<button
				type="submit"
				disabled={isSubmitting}
				class="rounded-lg border border-transparent bg-gradient-to-br from-indigo-500 via-violet-500 to-purple-500 px-4 py-2 text-sm font-medium text-white transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:focus:ring-offset-gray-900"
			>
