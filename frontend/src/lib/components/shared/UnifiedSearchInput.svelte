	...
	>
		...
		{#if showSaveButton && validationErrors.length === 0}
			<div class="relative flex-shrink-0">
				<button
					type="button"
					class="text-xs font-medium text-blue-500 transition hover:text-blue-300"
					...
					>
						<div class="py-1">
							...
							{#if canUpdateView}
								<button
									type="button"
									class="flex w-full items-center px-4 py-2.5 text-left transition hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl"
