					...
					<div class="space-y-1">
						{#each filteredTags as tag, index (tag.id)}
							...
							>
								...
								<button
									type="button"
									class="rounded px-2 py-1 text-xs text-gray-600 dark:text-gray-400 transition hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-gray-800 dark:hover:text-gray-200"
