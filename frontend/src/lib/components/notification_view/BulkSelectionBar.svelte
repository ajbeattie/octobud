...
{#if multiselectMode}
	...
	>
		...
		<div class="ml-auto flex flex-wrap items-center gap-2">
			...
			<button
				class="flex items-center gap-2 rounded-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-1.5 text-xs font-semibold text-gray-700 dark:text-white transition hover:bg-gray-100 dark:hover:bg-gray-700 disabled:opacity-50"
				type="button"
			...
			<button
				class="rounded-full border border-transparent px-3 py-1 text-xs font-medium text-indigo-700 dark:text-indigo-200 transition hover:bg-gray-100 dark:hover:bg-gray-900/60 disabled:opacity-50"
				type="button"
