<script lang="ts">
	...
	let unifiedSearchComponent: any = null;
...
<div class="flex items-center gap-2 pr-3 pt-4">
	<button
		type="button"
		class={`flex h-9 items-center justify-center rounded-full border px-4 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/40 ${
			multiselectMode
