		...
		>
			<div class="{buttonGroupBg} rounded-full p-0.5 flex items-center gap-0.5 shadow-lg">
				{#if subjectLink}
					...
					<a
						class="flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-gray-700 dark:text-gray-300 transition hover:bg-gray-200 dark:hover:bg-gray-700/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600"
						href={subjectLink}
						target="_blank"
				...
				<button
					type="button"
					class="flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-gray-700 dark:text-gray-300 transition hover:bg-gray-200 dark:hover:bg-gray-700/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/40"
				...
				<button
					type="button"
					class="flex h-10 w-10 items-center justify-center rounded-full bg-transparent transition hover:bg-gray-200 dark:hover:bg-gray-700/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/40 {notification.starred
						? 'text-violet-500'
						: 'text-gray-700 dark:text-gray-300'}"
					on:click|stopPropagation={() =>
