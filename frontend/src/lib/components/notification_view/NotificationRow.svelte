	...
	>
		<div class="flex-1 text-left space-y-1.5">
			...
			<div class="flex flex-wrap items-center gap-1.5 pl-6">
				<span
					class={`text-sm font-normal ${isUnread ? "text-gray-600" : "text-gray-500"} dark:text-gray-400`}
					>{repoLabel}</span
				>
		...
		>
			<div class="{buttonGroupBg} rounded-full p-0.5 flex items-center gap-0.5 shadow-lg">
				{#if subjectLink}
					...
					<a
						class="flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-gray-700 dark:text-gray-300 transition hover:bg-gray-200 dark:hover:bg-gray-700/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 cursor-pointer"
						href={subjectLink}
						target="_blank"
				...
				<button
					type="button"
					class="flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-gray-700 dark:text-gray-300 transition hover:bg-gray-200 dark:hover:bg-gray-700/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/40 cursor-pointer"
				...
				<button
					type="button"
					class="flex h-10 w-10 items-center justify-center rounded-full bg-transparent transition hover:bg-gray-200 dark:hover:bg-gray-700/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/40 cursor-pointer {notification.starred
						? 'text-violet-500'
						: 'text-gray-700 dark:text-gray-300'}"
					on:click|stopPropagation={() =>
