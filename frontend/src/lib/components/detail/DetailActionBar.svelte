<script lang="ts">
	...
	let snoozeDropdownComponent: any = null;
	let tagButtonElement: HTMLButtonElement | null = null;
	let tagDropdownComponent: any = null;
...
>
	...
	<div class="flex items-center gap-4">
		...
		{#if !hideBackButton}
			<button
				type="button"
				class="flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-gray-700 dark:text-gray-300 transition hover:bg-gray-100 dark:hover:bg-gray-700/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/40"
		...
		<div class="flex items-center gap-1">
			...
			<button
				type="button"
				class="flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-gray-700 dark:text-gray-300 transition hover:bg-gray-100 dark:hover:bg-gray-700/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/40 disabled:opacity-50"
			...
			<button
				type="button"
				class="flex h-10 w-10 items-center justify-center rounded-full bg-transparent transition hover:bg-gray-100 dark:hover:bg-gray-700/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/40 {notification.starred
					? 'text-violet-500'
	...
	{#if totalCount > 0 && currentIndex !== null}
		<div class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
			...
			<div class="flex items-center gap-1">
				<button
					type="button"
					class="flex h-8 w-8 items-center justify-center text-gray-600 dark:text-gray-400 transition hover:text-gray-800 dark:hover:text-gray-200 disabled:opacity-30 disabled:hover:text-gray-600 dark:disabled:hover:text-gray-400"
