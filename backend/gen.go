...
//go:generate mockgen -destination=internal/github/mocks/mock_sync.go -package=mocks github.com/ajbeattie/octobud/backend/internal/github/interfaces SyncOperations
...
//go:generate mockgen -source=internal/core/sync/service.go -destination=internal/core/sync/mocks/mock_service.go -package=mocks
...
//go:generate mockgen -source=internal/db/river.go -destination=internal/db/mocks/mock_river.go -package=mocks
//go:generate mockgen -source=internal/jobs/rule_matcher.go -destination=internal/jobs/mocks/mock_rule_matcher.go -package=mocks
