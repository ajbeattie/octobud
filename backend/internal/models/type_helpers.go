...
func IsUniqueViolation(err error) bool {
	...
	// Fallback: check error message for SQLSTATE 23505 in case errors.As doesn't traverse the chain
	// This handles cases where the error is wrapped with errors.Join
	errStr := err.Error()
	return strings.Contains(errStr, "SQLSTATE 23505") || strings.Contains(errStr, "23505")
}
