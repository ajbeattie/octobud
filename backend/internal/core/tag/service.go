...
type TagService interface {
	ListTagsWithUnreadCounts(ctx context.Context) ([]models.Tag, error)
	CreateTag(ctx context.Context, name string, color, description *string) (db.Tag, error)
	UpdateTag(
		ctx context.Context,
		tagID int64,
		name string,
	...
	ReorderTags(ctx context.Context, tagIDs []int64) ([]db.Tag, error)
	GetTag(ctx context.Context, tagID int64) (db.Tag, error)
	GetTagByName(ctx context.Context, name string) (db.Tag, error)
