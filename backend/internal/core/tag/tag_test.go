...
func TestService_ListTagsWithUnreadCounts(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := service.ListTagsWithUnreadCounts(ctx)
...
func TestService_CreateTag(t *testing.T) {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, name string, color *string, desc *string) {
				...
				m.EXPECT().
					...
					DoAndReturn(func(_ context.Context, arg db.UpsertTagParams) (db.Tag, error) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.CreateTag(ctx, tt.tagName, tt.color, tt.description)
...
func TestService_UpdateTag(t *testing.T) {
	tests := []struct {
		...
		color       *string
		description *string
		setupMock   func(*mocks.MockStore, int64, string, *string, *string)
		expectErr   bool
		checkErr    func(*testing.T, error)
		checkResult func(*testing.T, db.Tag)
	}{
		{
			...
			description: nil,
			setupMock: func(m *mocks.MockStore, id int64, name string, color *string, _ *string) {
				expectedTag := db.Tag{
					ID:    id,
					Name:  name,
					Slug:  "bug",
				...
				m.EXPECT().
					...
					DoAndReturn(func(_ context.Context, arg db.UpdateTagParams) (db.Tag, error) {
		...
		},
		{
			...
			color:       nil,
			description: nil,
			setupMock: func(m *mocks.MockStore, _ int64, _ string, _ *string, _ *string) {
				m.EXPECT().
					UpdateTag(gomock.Any(), gomock.Any()).
		...
		},
		{
			...
			color:       nil,
			description: nil,
			setupMock: func(_ *mocks.MockStore, _ int64, _ string, _ *string, _ *string) {
				// No mock expectations - should fail before DB call
			},
			expectErr: true,
			checkErr: func(t *testing.T, err error) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.UpdateTag(ctx, tt.tagID, tt.tagName, tt.color, tt.description)
...
func TestService_DeleteTag(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			err := service.DeleteTag(ctx, tt.tagID)
...
func TestService_ReorderTags(t *testing.T) {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, ids []int64) {
				m.EXPECT().
					...
					DoAndReturn(func(_ context.Context, arg db.UpdateTagDisplayOrderParams) error {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.ReorderTags(ctx, tt.tagIDs)
...
func TestService_GetTagByName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.GetTagByName(ctx, tt.tagName)
...
func TestService_CalculateTagUnreadCount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			count, err := service.calculateTagUnreadCount(ctx, tt.tagSlug)
