...
func TestService_BulkUpdate_MarkRead(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ []string) {
				...
				m.EXPECT().
					BulkMarkNotificationsRead(gomock.Any(), []string{"notif-1", "notif-2"}).
					Return(int64(2), nil)
			},
			expectErr: false,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			tt.setupMock(mockQuerier, tt.githubIDs)
...
func TestService_BulkUpdate_MarkNotificationsUnread(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ []string) {
				m.EXPECT().
					BulkMarkNotificationsUnread(gomock.Any(), []string{"notif-1", "notif-2"}).
					Return(int64(2), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_ArchiveNotifications(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ []string) {
				m.EXPECT().
					BulkArchiveNotifications(gomock.Any(), []string{"notif-1", "notif-2"}).
					Return(int64(2), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_SnoozeNotifications(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ []string, _ string) {
				m.EXPECT().
					BulkSnoozeNotifications(gomock.Any(), gomock.Any()).
					Return(int64(2), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockQuerier := mocks.NewMockStore(ctrl)
			tt.setupMock(mockQuerier, tt.githubIDs, tt.snoozedUntil)
			service := NewService(mockQuerier)
...
func TestService_BulkUpdate_UnarchiveNotifications(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ []string) {
				m.EXPECT().
					BulkUnarchiveNotifications(gomock.Any(), []string{"notif-1", "notif-2"}).
					Return(int64(2), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_UnsnoozeNotifications(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ []string) {
				m.EXPECT().
					BulkUnsnoozeNotifications(gomock.Any(), []string{"notif-1", "notif-2"}).
					Return(int64(2), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_MuteNotifications(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ []string) {
				m.EXPECT().
					BulkMuteNotifications(gomock.Any(), []string{"notif-1", "notif-2"}).
					Return(int64(2), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_UnmuteNotifications(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ []string) {
				m.EXPECT().
					BulkUnmuteNotifications(gomock.Any(), []string{"notif-1", "notif-2"}).
					Return(int64(2), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_StarNotifications(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ []string) {
				m.EXPECT().
					BulkStarNotifications(gomock.Any(), []string{"notif-1", "notif-2"}).
					Return(int64(2), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_UnstarNotifications(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ []string) {
				m.EXPECT().
					BulkUnstarNotifications(gomock.Any(), []string{"notif-1", "notif-2"}).
					Return(int64(2), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_UnfilterNotifications(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ []string) {
				m.EXPECT().
					BulkMarkNotificationsUnfiltered(gomock.Any(), []string{"notif-1", "notif-2"}).
					Return(int64(2), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_MarkNotificationsReadByQuery(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ string) {
				m.EXPECT().
					BulkMarkNotificationsReadByQuery(gomock.Any(), gomock.Any()).
					Return(int64(2), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockQuerier := mocks.NewMockStore(ctrl)
			tt.setupMock(mockQuerier, tt.queryStr)
			service := NewService(mockQuerier)
...
func TestService_BulkUpdate_MarkNotificationsUnreadByQuery(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ string) {
				m.EXPECT().
					BulkMarkNotificationsUnreadByQuery(gomock.Any(), gomock.Any()).
					Return(int64(1), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_ArchiveNotificationsByQuery(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ string) {
				m.EXPECT().
					BulkArchiveNotificationsByQuery(gomock.Any(), gomock.Any()).
					Return(int64(1), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_UnarchiveNotificationsByQuery(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ string) {
				m.EXPECT().
					BulkUnarchiveNotificationsByQuery(gomock.Any(), gomock.Any()).
					Return(int64(1), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_SnoozeNotificationsByQuery(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ string, _ string) {
				m.EXPECT().
					BulkSnoozeNotificationsByQuery(gomock.Any(), gomock.Any()).
					Return(int64(1), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockQuerier := mocks.NewMockStore(ctrl)
			tt.setupMock(mockQuerier, tt.queryStr, tt.snoozedUntil)
			service := NewService(mockQuerier)
...
func TestService_BulkUpdate_UnsnoozeNotificationsByQuery(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ string) {
				m.EXPECT().
					BulkUnsnoozeNotificationsByQuery(gomock.Any(), gomock.Any()).
					Return(int64(1), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_MuteNotificationsByQuery(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ string) {
				m.EXPECT().
					BulkMuteNotificationsByQuery(gomock.Any(), gomock.Any()).
					Return(int64(1), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_UnmuteNotificationsByQuery(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ string) {
				m.EXPECT().
					BulkUnmuteNotificationsByQuery(gomock.Any(), gomock.Any()).
					Return(int64(1), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_StarNotificationsByQuery(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ string) {
				m.EXPECT().
					BulkStarNotificationsByQuery(gomock.Any(), gomock.Any()).
					Return(int64(1), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
...
func TestService_BulkUpdate_UnstarNotificationsByQuery(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ string) {
				m.EXPECT().
					BulkUnstarNotificationsByQuery(gomock.Any(), gomock.Any()).
					Return(int64(1), nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, count int64) {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, _ string) {
				...
				notifications := []db.Notification{
					{ID: 1, GithubID: "notif-1", Filtered: true, ImportedAt: now},
					{ID: 2, GithubID: "notif-2", Filtered: true, ImportedAt: now},
				}
				m.EXPECT().
