...
func (s *Service) AssignTag(
	...
	if err != nil {
		return db.Notification{}, errors.Join(ErrFailedToUpdateTagIDs, err)
	}

	// Return the updated notification
	updatedNotification, err := s.queries.GetNotificationByGithubID(ctx, githubID)
	if err != nil {
