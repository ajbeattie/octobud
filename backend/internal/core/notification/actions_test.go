...
func TestService_MarkNotificationRead(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id string) {
				...
				m.EXPECT().
					MarkNotificationRead(gomock.Any(), id).
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := service.MarkNotificationRead(ctx, tt.githubID)
...
func TestService_MarkNotificationUnread(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id string) {
				...
				m.EXPECT().
					MarkNotificationUnread(gomock.Any(), id).
					Return(expectedNotification, nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, notification db.Notification) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.MarkNotificationUnread(ctx, tt.githubID)
...
func TestService_ArchiveNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id string) {
				...
				m.EXPECT().
					ArchiveNotification(gomock.Any(), id).
					Return(expectedNotification, nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, notification db.Notification) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.ArchiveNotification(ctx, tt.githubID)
...
func TestService_UnarchiveNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id string) {
				...
				m.EXPECT().
					UnarchiveNotification(gomock.Any(), id).
					Return(expectedNotification, nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, notification db.Notification) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.UnarchiveNotification(ctx, tt.githubID)
...
func TestService_MuteNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id string) {
				...
				m.EXPECT().
					MuteNotification(gomock.Any(), id).
					Return(expectedNotification, nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, notification db.Notification) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.MuteNotification(ctx, tt.githubID)
...
func TestService_UnmuteNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id string) {
				...
				m.EXPECT().
					UnmuteNotification(gomock.Any(), id).
					Return(expectedNotification, nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, notification db.Notification) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.UnmuteNotification(ctx, tt.githubID)
...
func TestService_UnsnoozeNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id string) {
				...
				m.EXPECT().
					UnsnoozeNotification(gomock.Any(), id).
					Return(expectedNotification, nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, notification db.Notification) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.UnsnoozeNotification(ctx, tt.githubID)
...
func TestService_StarNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id string) {
				...
				m.EXPECT().
					StarNotification(gomock.Any(), id).
					Return(expectedNotification, nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, notification db.Notification) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.StarNotification(ctx, tt.githubID)
...
func TestService_UnstarNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id string) {
				...
				m.EXPECT().
					UnstarNotification(gomock.Any(), id).
					Return(expectedNotification, nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, notification db.Notification) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.UnstarNotification(ctx, tt.githubID)
...
func TestService_UnfilterNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id string) {
				...
				m.EXPECT().
					MarkNotificationUnfiltered(gomock.Any(), id).
					Return(expectedNotification, nil)
			},
			expectErr: false,
			checkResult: func(t *testing.T, notification db.Notification) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.UnfilterNotification(ctx, tt.githubID)
...
func TestService_SnoozeNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id string, untilStr string) {
				now := time.Now().UTC()
				...
				m.EXPECT().
					SnoozeNotification(gomock.Any(), gomock.Any()).
					DoAndReturn(func(_ context.Context, arg db.SnoozeNotificationParams) (db.Notification, error) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockQuerier := mocks.NewMockStore(ctrl)
			tt.setupMock(mockQuerier, tt.githubID, tt.snoozedUntil)
			service := NewService(mockQuerier)

			ctx := context.Background()
			result, err := service.SnoozeNotification(ctx, tt.githubID, tt.snoozedUntil)
