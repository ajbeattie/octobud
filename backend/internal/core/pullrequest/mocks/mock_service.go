...
func (m *MockPullRequestService) UpsertPullRequest(ctx context.Context, params db.UpsertPullRequestParams) (db.PullRequest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpsertPullRequest", ctx, params)
...
func (mr *MockPullRequestServiceMockRecorder) UpsertPullRequest(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpsertPullRequest", reflect.TypeOf((*MockPullRequestService)(nil).UpsertPullRequest), ctx, params)
}
