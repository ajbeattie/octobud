...
func (s *Service) calculateInboxUnreadCount(ctx context.Context) (int64, error) {
...
func (s *Service) calculateEverythingUnreadCount(ctx context.Context) (int64, error) {
...
func (s *Service) calculateArchiveUnreadCount(ctx context.Context) (int64, error) {
...
func (s *Service) calculateSnoozedUnreadCount(ctx context.Context) (int64, error) {
...
func (s *Service) calculateStarredUnreadCount(ctx context.Context) (int64, error) {
