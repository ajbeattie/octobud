...
type RepositoryService interface {
	...
	ListRepositoriesAsMap(ctx context.Context) (map[int64]db.Repository, error)
	GetRepositoryByID(ctx context.Context, id int64) (db.Repository, error)
	UpsertRepository(ctx context.Context, params db.UpsertRepositoryParams) (db.Repository, error)
}
