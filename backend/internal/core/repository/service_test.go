...
func TestService_ListRepositories(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := service.ListRepositories(ctx)
...
func TestService_ListRepositoriesAsMap(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.ListRepositoriesAsMap(ctx)
...
func TestService_GetRepositoryByID(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mocks.MockStore, id int64) {
				...
				m.EXPECT().
					GetRepositoryByID(gomock.Any(), id).
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			result, err := service.GetRepositoryByID(ctx, tt.repoID)
