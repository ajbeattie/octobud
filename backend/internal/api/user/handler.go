...
type Handler struct {
	...
	tokenRevocation *auth.TokenRevocation
	secureCookies   bool                       // Force secure cookies (overrides auto-detection if true)
	riverClient     db.RiverClient             // Optional: for queueing sync jobs
	syncStateSvc    syncstate.SyncStateService // Optional: for sync state operations
}
...
// WithRiverClient sets the River client for queueing jobs
func (h *Handler) WithRiverClient(client db.RiverClient) *Handler {
...
// HandleLogin handles POST /api/user/login
func (h *Handler) HandleLogin(w http.ResponseWriter, r *http.Request) {
	...
	auth.SetCSRFCookie(w, csrfToken, h.secureCookies, r)
...
// HandleRefreshToken handles POST /api/user/refresh
...
// HandleLogout handles POST /api/user/logout
...
func (h *Handler) HandleLogout(w http.ResponseWriter, r *http.Request) {
	...
	auth.ClearCSRFCookie(w, h.secureCookies, r)
...
// HandleUpdateCredentials handles PUT /api/user/credentials
