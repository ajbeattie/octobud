...
import (
	...
	notificationmocks "github.com/ajbeattie/octobud/backend/internal/core/notification/mocks"
...
func TestHandler_handleNotificationAction(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					MarkNotificationRead(gomock.Any(), "test-id").
					Return(db.Notification{}, nil)
				mockSvc.EXPECT().
					GetNotificationWithDetails(gomock.Any(), "test-id", "").
		...
		},
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					MarkNotificationRead(gomock.Any(), "not-found").
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			handler, mockSvc, _ := setupTestHandler(ctrl)
			if tt.setupMock != nil {
...
func TestHandler_handleSnoozeNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					SnoozeNotification(gomock.Any(), "test-id", "2024-12-31T23:59:59Z").
					Return(db.Notification{}, nil)
				mockSvc.EXPECT().
					GetNotificationWithDetails(gomock.Any(), "test-id", "").
					Return(models.Notification{ID: 1, GithubID: "test-id"}, nil)
		...
		},
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					SnoozeNotification(gomock.Any(), "not-found", "2024-12-31T23:59:59Z").
					Return(db.Notification{}, sql.ErrNoRows)
			},
			expectedStatus: http.StatusNotFound,
		},
...
func TestHandler_handleAssignTagToNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					AssignTag(gomock.Any(), "test-id", int64(1)).
					Return(db.Notification{}, nil)
				mockSvc.EXPECT().
					GetNotificationWithDetails(gomock.Any(), "test-id", "").
					Return(models.Notification{ID: 1, GithubID: "test-id"}, nil)
		...
		},
		{
			...
			githubID:       "test-id",
			requestBody:    assignTagRequest{TagID: 0},
			setupMock:      func(*notificationmocks.MockNotificationService) {},
			expectedStatus: http.StatusBadRequest,
		},
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					AssignTag(gomock.Any(), "test-id", int64(999)).
		...
		},
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					AssignTag(gomock.Any(), "not-found", int64(1)).
...
func TestHandler_handleAssignTagByName(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					AssignTagByName(gomock.Any(), "test-id", "test-tag").
					Return(db.Notification{}, nil)
				mockSvc.EXPECT().
					GetNotificationWithDetails(gomock.Any(), "test-id", "").
					Return(models.Notification{ID: 1, GithubID: "test-id"}, nil)
		...
		},
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					AssignTagByName(gomock.Any(), "not-found", "test-tag").
					Return(db.Notification{}, notificationcore.ErrNotificationNotFound)
			},
			expectedStatus: http.StatusNotFound,
		},
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					AssignTagByName(gomock.Any(), "test-id", "!!!").
...
func TestHandler_handleRemoveTagFromNotification(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					RemoveTag(gomock.Any(), "test-id", int64(1)).
					Return(db.Notification{}, nil)
				mockSvc.EXPECT().
					GetNotificationWithDetails(gomock.Any(), "test-id", "").
					Return(models.Notification{ID: 1, GithubID: "test-id"}, nil)
		...
		{
			name:           "invalid tagId returns 400",
			githubID:       "test-id",
			tagID:          "invalid",
			setupMock:      func(*notificationmocks.MockNotificationService) {},
			expectedStatus: http.StatusBadRequest,
		},
		{
			...
			setupMock: func(mockSvc *notificationmocks.MockNotificationService) {
				mockSvc.EXPECT().
					RemoveTag(gomock.Any(), "not-found", int64(1)).
					Return(db.Notification{}, notificationcore.ErrNotificationNotFound)
			},
			expectedStatus: http.StatusNotFound,
		},
