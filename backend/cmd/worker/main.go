...
func main() {
	...
	river.AddWorker(workers, jobs.NewSyncNotificationsWorker(syncService, riverClient))
	...
	log.Println("worker: registered 3 workers (SyncNotifications, ProcessNotification, ApplyRule)")
