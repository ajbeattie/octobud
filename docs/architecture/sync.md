...
Octobud uses incremental syncing to be efficient:

- **First Sync** — When you first start Octobud, it fetches all your notifications
...
By default, Octobud syncs every 30 seconds. This can be configured via environment variables. The sync interval balances:
...
- Initial sync may take a few minutes depending on how many notifications you have
- All your existing notifications will be imported
- You can start using Octobud while the initial sync completes
