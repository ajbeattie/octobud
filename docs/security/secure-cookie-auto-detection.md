...
- Secure cookies provide protection against cookie interception
- Combined with HTTPS, secure cookies provide defense-in-depth
- For local/home lab deployments, evaluate your security requirements based on network access

## Related Documentation

- [Deployment Guide](../deployment.md) — Full deployment instructions
- [Reverse Proxy Setup](../deployment.md#reverse-proxy-setup) — Configuring nginx/Caddy
