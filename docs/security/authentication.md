...
See [Secure Cookie Auto-Detection](secure-cookie-auto-detection.md) for how CSRF cookies are secured.
...
- [Secure Cookie Auto-Detection](secure-cookie-auto-detection.md) — How CSRF cookies are secured
- [Rate Limiting and DoS Protection](rate-limiting.md) — Brute-force protection
